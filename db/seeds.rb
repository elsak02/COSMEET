...
quentin = User.create!(email: "quentin@cosmeet.com", password: "123456", admin: true, name: "Quentin", birth_date: "1990-09-22", birth_time: "16:30", birth_place:"Rueil-Malmaison", gender: "Man", sexual_preference: "Both", relationship_type:"fun", element_ranking: ["water","fire","earth","air"], mode_ranking: ["cardinal","fixed","mutable"], personality_traits: ["adventurous", "go-getter", "curious"], latitude: 48.88, longitude: 2.20, biography: "US football fan, I coach teams for a living. I also love to spend time with Mango my cat.", age_preference: [18, 25], activities: ["geeking", "socializing", "football"])
...
patricia = User.create!(email: "patricia@cosmeet.com", password: "123456", name: "Patricia", birth_date: "1999-08-27", birth_time: "3:40", birth_place: "Paris", gender: "Woman", sexual_preference: "Woman", relationship_type: "fun", element_ranking: ["water","air","earth","fire"], mode_ranking: ["fixed","mutable","cardinal"], personality_traits: ["cheerful", "expressive", "inventive"], latitude: 48.83, longitude: 2.32, biography: "Girl just wanna fun!", age_preference: [25, 35], activities: ["partying", "socializing", "meditation"])
...
julien = User.create!(email: "julienb@cosmeet.com", password: "123456", name: "Julien", birth_date: "1995-02-17", birth_time: "14:02", birth_place: "Paris", gender: "Man", sexual_preference: "Both", relationship_type: "fun", element_ranking: ["earth","air","water","fire"], mode_ranking: ["cardinal","fixed","mutable"], personality_traits: ["independent", "progressive", "humanitarian"], latitude: 48.85, longitude: 2.34, biography: "I traveled around the world but I still have not find my soulmate yet.", age_preference: [25, 35], activities: ["partying", "socializing", "meditation"])
